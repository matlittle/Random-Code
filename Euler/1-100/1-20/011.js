...
function checkType(grid, x, y, type) {
    switch (type) {
        case 'vertical':
            if (grid[x + 3] !== undefined && grid[x + 3][y] !== undefined)
                return true;
            return false;
        case 'horizontal':
            if (grid[x] !== undefined && grid[x][y + 3] !== undefined)
                return true;
            return false;
        case 'upDiagonal':
            if (grid[x + 3] !== undefined && grid[x + 3][y + 3] !== undefined)
                return true;
            return false;
        case 'downDiagonal':
            if (grid[x + 3] !== undefined && grid[x + 3][y - 3] !== undefined)
...
function getNextFour(grid, x, y, type) {
    switch (type) {
        case 'vertical':
